...
export const LOAD_REF_EXPLICIT_MISSING: string[] = [
  ...
  // ── Additional explicit-missing variants (English) ──────────────
  'please send load ref',
  'please send the loadref',
  'please send the loadrefs',
  'please send loadref',
  'load ref still missing',
  'no load ref received',
  'loadref missing',
  'release ref missing',
  'missing release reference',
  'please provide release ref',
  'loading reference missing',
  'reference required for loading',
  'load ref not received',
  'loadref required',
  'no loadref',
  'no load reference',
  ...
  'graag laadreferentie sturen',
  'loadref nog niet ontvangen',
  'laadreferentie niet ontvangen',
  'laadreferentie ontbr',
  'graag de loadref',
  'loadref nog niet',
  'laadreferentie nog niet',
  'laadreferentie missen',
  'ontbrekende laadreferentie',
  // ── German variants ──────────────────────────────────────────────
  'ladereferenz fehlt',
  'lade referenz fehlt',
  'bitte ladereferenz senden',
  'referenz fehlt',
  'ladung referenz fehlt',
  'ladereferenz nicht erhalten',
  'ladereferenz wird benoetigt',
