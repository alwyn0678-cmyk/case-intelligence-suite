...
COLUMN_ALIASES: dict[str, list[str]] = {
    "subject":     ["subject", "title", "case subject", "case title", "onderwerp", "email subject",
                    "case name", "issue", "summary", "header", "naam", "onderwerp email"],
    "description": ["description", "desc", "case description", "body", "email body", "message body",
                    "comments", "details", "notes", "note", "message", "content", "text",
                    "case comments", "case notes", "case details", "issue description",
                    "omschrijving", "notities", "beschrijving", "toelichting"],
    "isr_details": ["isr details", "isr_details", "isr", "isr detail", "sr details", "internal details",
                    "internal notes", "internal comments", "agent notes", "resolution notes",
                    "internal", "work notes", "additional info", "aanvullende info"],
    "customer":    ["customer", "account", "client", "company", "klant", "account name",
                    "customer name", "debtor", "shipper", "consignee", "contact company",
                    "opdrachtgever", "bedrijf"],
    "transporter": ["transporter", "haulier", "carrier", "hauler", "transport company",
                    "vervoerder", "forwarder", "freight forwarder", "trucking company",
                    "haulage company", "trucking", "vervoersbedrijf"],
    "zip":         ["zip", "postcode", "post code", "zip code", "zipcode", "postal code",
                    "postal_code", "plz", "postleitzahl"],
    "area":        ["area", "region", "zone", "terminal", "location", "hub", "site",
                    "depot", "warehouse", "facility"],
    "date":        ["date", "created date", "creation date", "created at", "created_at",
                    "closed date", "datum", "opened", "open date", "open_date",
                    "incident date", "reported date", "log date"],
    "status":      ["status", "case status", "state", "resolution", "case state"],
    "priority":    ["priority", "urgency", "severity", "prioriteit"],
    "category":    ["category", "type", "case type", "issue type", "categorie",
                    "problem type", "request type", "classification", "classificatie"],
    "hours":       ["hours", "time spent", "duration", "effort", "uren"],
    "case_number": ["case number", "case no", "case no.", "case #", "case id", "ticket number",
                    "ticket id", "incident number", "case ref", "case_number", "casenumber",
                    "case nr", "ticket", "ref", "reference", "issue number", "sr number",
                    "service request", "zaaknummer"],
    "booking_ref": ["booking", "booking ref", "booking reference", "booking no", "booking number",
                    "bkg", "bkg ref", "booking_ref", "reservation", "res no",
                    "boekingsnummer", "boeking"],
}
...
_OPERATIONAL_CLUES = [
    ...
    ('clearance',   'customs',           'unknown'),
    ('invoice',     'rate',              'unknown'),
    ('billing',     'rate',              'unknown'),
    ('demurrage',   'waiting_time',      'unknown'),
    ('detention',   'waiting_time',      'unknown'),
    ('driver',      'delay',             'unknown'),
    ('delivery',    'delay',             'unknown'),
    ('collection',  'delay',             'unknown'),
    ('amendment',   'amendment',         'amended'),
    ('correction',  'amendment',         'amended'),
    ('schedule',    'scheduling',        'unknown'),
    ('slot',        'scheduling',        'unknown'),
    ('cutoff',      'scheduling',        'unknown'),
    ('cut-off',     'scheduling',        'unknown'),
    ('release',     'equipment_release', 'unknown'),
    ('empty',       'equipment_release', 'unknown'),
    ('depot',       'equipment_release', 'unknown'),
    ('return',      'equipment_release', 'unknown'),
    ('damage',      'damage',            'unknown'),
    ('claim',       'damage',            'unknown'),
    ('complaint',   'communication',     'escalated'),
    ('pickup',      'pickup_delivery',   'unknown'),
    ('pick-up',     'pickup_delivery',   'unknown'),
    ('pre-alert',   'shipping_advice',   'unknown'),
    ('pre alert',   'shipping_advice',   'unknown'),
    ('pre-advise',  'shipping_advice',   'unknown'),
    ('booking',     'load_ref',          'unknown'),
    ('loadref',     'load_ref',          'unknown'),
    ('load ref',    'load_ref',          'unknown'),
    ('vgm',         'vgm',               'unknown'),
    ('seal',        'seal',              'unknown'),
    ('dangerous',   'dangerous_goods',   'unknown'),
    ('hazmat',      'dangerous_goods',   'unknown'),
    ('bl ',         'bl',                'unknown'),
    ('bill of lading', 'bl',             'unknown'),
    ('portbase',    'portbase',          'unknown'),
    ('capacity',    'capacity',          'unknown'),
    ('availability','capacity',          'unknown'),
    # ── Dutch ────────────────────────────────────────────────────
    ...
    ('lading',      'tracking',          'unknown'),
    ('schip',       'tracking',          'unknown'),
    ('binnenschip', 'tracking',          'unknown'),
    ('haven',       'tracking',          'unknown'),
    ('kade',        'tracking',          'unknown'),
    ('containerterminal', 'tracking',    'unknown'),
    ('referentie',  'load_ref',          'unknown'),
    ('laadreferentie', 'load_ref',       'unknown'),
    ('factuur',     'rate',              'unknown'),
    ('kosten',      'rate',              'unknown'),
    ('schade',      'damage',            'unknown'),
    ('leeg',        'equipment_release', 'unknown'),
    ('retour',      'equipment_release', 'unknown'),
    ('vrijgave',    'equipment_release', 'unknown'),
    ('losplaats',   'tracking',          'unknown'),
    ('laadplaats',  'tracking',          'unknown'),
    # ── German ───────────────────────────────────────────────────
    ...
    ('schiff',      'tracking',          'unknown'),
    ('hafen',       'tracking',          'unknown'),
    ('verladen',    'equipment',         'unknown'),
    ('leer',        'equipment_release', 'unknown'),
    ('rückgabe',    'equipment_release', 'unknown'),
    ('freigabe',    'equipment_release', 'unknown'),
